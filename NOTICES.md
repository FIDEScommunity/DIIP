...
Contact for Code of Conduct issues or inquires: <a href="mailto:harmen@fides.community">Harmen van der Kooij</a>, <a href="mailto:samuel.rinnetmaki@findy.fi">Samuel Rinnetmäki</a>.

Alternatively, you can contact anyone listed in the [CODEOWNERS](CODEOWNERS) file in this repository.

You can also ask questions or file complaints using the `#diip` channel in the [OpenWallet Foundation's Discord server](https://discord.gg/openwalletfoundation).
